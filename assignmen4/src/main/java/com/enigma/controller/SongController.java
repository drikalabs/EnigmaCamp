...
public class SongController {
    ...
    @GetMapping("/detailsongs")
    public String getSongsById(Model model, @RequestParam Integer idSong) {
        Song songs = songRepositories.findById(idSong).get();
        model.addAttribute("data", songs);
        return "songs/detail";
    }
}
